...
function renderSepetDetay() {
  ...
  if(!proposals || proposals.length === 0) {
    el.innerHTML='<div class="admin-empty">Firestore bağlantısı bekleniyor... Sayfayı yenileyip tekrar deneyin.</div>';
    return;
  }
  ...
  // Tümünü sil butonu
  const clearBtn = `<div style="display:flex;justify-content:flex-end;margin-bottom:10px">
  ...
  el.innerHTML = clearBtn + Object.entries(byUser).map(([user,d])=>{
