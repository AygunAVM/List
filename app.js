...
// Nakit fiyatı döndürür — ₺ işareti EKLEMEZ (çift ₺ olmasın diye)
function _urunFmt(u) {
  const keys = Object.keys(u);
...
// Ürün adından marka önekini çıkar (trend kartlarda marka yazmasın)
...
// Vitrin ürününü allProducts'ta bul — productIdx varsa kullan, yoksa tam isim eşleştir
