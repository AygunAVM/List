...
function _renderMyStatsUI() {
  ...
  container.innerHTML = `
    ...
    <!-- ⭐ Haftanın Yıldızı -->
    ${star ? `
    <div class="ms-section-title" style="margin-top:14px">⭐ Haftanın Yıldızı</div>
    <div class="ms-yildiz-card ${benimYildiz ? 'ms-yildiz-ben' : ''}">
      ...
      ${!benimYildiz ? `<div style="font-size:.68rem;color:var(--text-3);text-align:right">Senin:<br><strong>${d.hafta.satis}</strong></div>` : ''}
    </div>
    ` : ''}
