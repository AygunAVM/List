...
// Admin panelinden değiştirilebilir — localStorage'da saklanır.
// Varsayılan: 'En iyisiniz'
const _GREETING_KEY = 'aygun_greeting';
function _getGreeting() {
  return localStorage.getItem(_GREETING_KEY) || 'En iyisiniz';
}
// ─────────────────────────────────────────────────────────────────────────────
...
async function showApp() {
  ...
  if (searchEl) {
    ...
    searchEl.placeholder = ad ? _getGreeting() + ', ' + ad + ' — Ürün arama' : 'Ürün arama';
  }
...
function _startMotdTicker() {
  ...
  const ad = currentUser?.Ad || currentUser?.Email?.split('@')[0] || '';
  const staticPlaceholder = ad ? _getGreeting() + ', ' + ad + ' — Ürün arama' : 'Ürün arama';
