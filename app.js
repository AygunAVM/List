...
function _updateChangeBtn() {
  requestAnimationFrame(() => {
    ...
    // Admin: tümü işaretlenmeden geçemez
    // Satış kullanıcısı: buton her zaman aktif (işaretleme opsiyonel)
    const mustCheck = isAdmin();
    const canClose  = !mustCheck || ready;
    ...
    if(ready) {
      ...
      btn.textContent = 'Tüm değişimleri işaretleyin (' + allNew.length + ' kaldı)';
    } else {
      btn.textContent = '✓ Anladım, Kapat';
    }
  });
