...
const Basket = {
  ...
  totals() {
    return basket.reduce((t, i) => {
      ...
      const efektif = i._nakitOverride !== undefined ? i._nakitOverride  // Manuel override her şeye üstün
                    : i._projeNakit   !== undefined ? i._projeNakit     // ❖ Proje fiyatı
                    : (i.nakit || 0);                                     // Ham nakit
      t.nakit += efektif;
      return t;
...
function _buildAdminCartHTML() {
  ...
  basket.forEach((item, idx) => {
    ...
    const efektifFiyat = hasOverride  ? item._nakitOverride  // Manuel override her şeye üstün
                       : projeAktif  ? item._projeNakit     // ❖ Proje
