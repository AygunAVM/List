...
function toggleCampaign(idx, campIdx) {
  ...
  // ═══════════════════════════════════════════════════════════
  // KURAL 1b: Aynı üründe birden fazla 🔒 kampanya seçilemez
  //   CMI 97302'de IKILI seçiliyse KM artık seçilemez (ve tersi).
  // ═══════════════════════════════════════════════════════════
  if (camp.tip === 'kilitli' && itemHasKilitli) {
    _campToast('Bu üründe zaten bir 🔒 kampanya seçili. Önce onu kaldırın.', 'warn');
    return;
  }
...
async function finalizeAksiyon() {
  ...
  // Pazarlık indirimi — kart seçiliyse abakusSelection'dan, nakit seçiliyse doğrudan inputtan al
