// ═══════════════════════════════════════════════════════════════
//  AYGÜN AVM — app.js  (Rev 7.0 — Okuma Kotası Optimizasyonu)
...
//    kısmını tüketiyordu.
//  · _ensureSummariesExist varsayılan aralığı 365 → 30 güne indirildi
//    (geçmiş özetler zaten kalıcı; her seferinde 1 yıl taramaya gerek yok).
...
//    çalışmasın diye).
//  · Firestore, WebChannel/Listen 404 hatalarını azaltmak için
//    experimentalAutoDetectLongPolling ile başlatılıyor.
//
//  Rev 6.0 YENİLİKLERİ:
...
// ✅ Rev 7.0: experimentalAutoDetectLongPolling — bazı ağlarda/tarayıcı
// uzantılarında görülen "Listen/channel ... 404" WebChannel hatalarını
// azaltır. Bu hatalar zaten _safeListener() tarafından retry ile telafi
// ediliyordu, ama her retry proposals/sales gibi limitsiz koleksiyonları
// baştan okutuyordu — bu değişiklik reconnect sıklığını azaltarak
// dolaylı okuma tasarrufu sağlar.
const _db    = initializeFirestore(_fbApp, { experimentalAutoDetectLongPolling: true });
