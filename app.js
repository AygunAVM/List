...
function _doUpdateChangeBtn() {
  ...
  // Admin: "Tümünü işaretle" siyah bantta göster
  ...
  if(canClose) {
    ...
    btn.textContent = mandatoryLeft + ' onay kaldı';
  }

  // Siyah bant bilgilendirme
  const sub = document.getElementById('change-header-sub');
  if(sub && canClose) sub.textContent = 'Tüm değişimler onaylandı';
}
