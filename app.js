...
function _updateChangeBtn() {
  ...
  if(!btn) return;
  // Tüm yeni (chk-box, chk-done değil) işaretlendi mi?
  const allBoxes  = document.querySelectorAll('#change-list .chk-box:not(.chk-done-preset)');
...
Object.assign(window, {
  ...
  clearAllPendingProps, logoutUser, toggleChangeItem,
