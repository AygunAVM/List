...
function qfAddToBasket() {
  ...
  // Son eklenen item = basket'in ilk elemanı (unshift ile ekleniyor)
  if (basket.length > 0 && _qfPlan.tahsilat > 0) {
    const lastItem = basket[0];
    // Planın tahsilatını nakit olarak, orijinal nakiti ayrıca sakla
    lastItem._nakitOrijinal = lastItem.nakit;
    lastItem.nakit          = _qfPlan.tahsilat;
