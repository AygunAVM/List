...
function openQuickFinance(urunIdx, nakitFiyat) {
  ...
  if (_addBtn2) _addBtn2.disabled = true;
  if (_payBtn2) _payBtn2.disabled = true;
  if (_planLbl) { _planLbl.textContent = 'Plan seçin →'; _planLbl.classList.remove('has-plan'); }
