...
function openQuickFinance(urunIdx, nakitFiyat) {
  ...
  if (aciklama.includes('\u2756')) {
    kampanyaBanner = '<div class="qf-camp-banner" style="background:linear-gradient(135deg,#f3e8ff,#ede9fe);border-color:#7c3aed;color:#4c1d95">' +
      ...
      '<button onclick="closeQuickFinance();toggleCart();" style="margin-top:7px;width:100%;padding:7px;background:#7c3aed;color:#fff;border:none;border-radius:8px;font-size:.70rem;font-weight:700;cursor:pointer;">\uD83D\uDED2 Sepete Git \u2192</button>' +
      '</div>';
